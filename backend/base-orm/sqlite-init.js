...
=======
    "SELECT count(*) as contar FROM sqlite_schema WHERE type = 'table' and name= 'vendedores'";
>>>>>>> e835a45da833b608d3995f4e3ac0f0fecfa796ec
  res = await db.get(sql, []);
  if (res.contar > 0) existe = true;
...
=======
    // Crear la tabla 'vendedores' si no existe
    await db.run(
      `CREATE TABLE vendedores(
         IdVendedores INTEGER PRIMARY KEY AUTOINCREMENT,
>>>>>>> e835a45da833b608d3995f4e3ac0f0fecfa796ec
...
=======
    console.log("Datos de ejemplo insertados en la tabla 'vendedores'");
>>>>>>> e835a45da833b608d3995f4e3ac0f0fecfa796ec
  }
  // cerrar la base
  db.close();
